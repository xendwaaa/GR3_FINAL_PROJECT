                 ...
                 <img src="image/bg4.jpg" class="d-block w-100" alt="...">
                      <div class="carousel-caption d-none d-md-block">
                          <h1 class="caption"><strong>Welcome to My Food Recipe</strong></h1>
                             <p class="caption caption-p">Discover the joy of cooking with our easy-to-follow recipes and interactive features. Whether you're preparing a quick meal or experimenting with new dishes, our platform is designed to make your culinary experience enjoyable and stress-free. Let's cook something amazing together!</p>
                      </div>
                 </div>
    <div class="carousel-item">
        <img src="image/bg3.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
            <h1 class="caption"><strong>Learn to Cook</strong></h1>
            <p class="caption caption-p">Unlock the chef within you by exploring a variety of cooking techniques and tips. Our step-by-step guides and expertly curated recipes will help you master the art of cooking and create dishes that everyone will love.</p>
        </div>
    </div>
    <div class="carousel-item">
        <img src="image/bg5.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
            <h1 class="caption"><strong>Make Your Own Recipe</strong></h1>
            <p class="caption caption-p">Unleash your creativity in the kitchen by designing your own recipes. Experiment with flavors, ingredients, and techniques to craft unique dishes that showcase your personal culinary style. The possibilities are endless!</p>
        </div>
    </div>
</div>
